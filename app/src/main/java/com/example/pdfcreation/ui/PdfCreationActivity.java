package com.example.pdfcreation.ui;
...
import com.example.pdfcreation.R;
import com.example.pdfcreation.adapter.PdfCreateAdapter;
import com.example.pdfcreation.model.PDFModel;
import com.example.pdfcreation.utils.PDFCreationUtils;
import com.example.pdfcreation.utils.PdfBitmapCache;
...
public class PdfCreationActivity extends AppCompatActivity {
    ...
    private void sharePdf(String fileName) {
        ...
        Uri u = FileProvider.getUriForFile(this, this.getApplicationInfo().packageName, fileIn);
